...
const moveUpEffect = `absolute bg-inherit rounded z-10 transition-all duration-300 block text-gray-500 pl-2
                     peer-focus:-top-1 peer-focus:text-xs peer-focus:px-3 peer-focus:text-black peer-focus:font-semibold 
                     peer-[:not(:placeholder-shown)]:-top-1 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:px-3
                     peer-[:not(:placeholder-shown)]:text-black peer-[:not(:placeholder-shown)]:bg-inherit
